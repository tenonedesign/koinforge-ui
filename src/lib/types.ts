import { balanceToFloat, getAccountRc, pobRead, poolRead, poolsRead, tokenBalanceOf, tokenTotalSupply, vaporBalanceOf } from "$lib/utils";
import { env, poolsOwner } from "$lib/stores";
...
export class User {
  ...
  // {
  //   "owner": "19JntSm8pSNETT9aHTwAUHC5RMoaSmgZPJ",
...
export class KoinosNode {
  constructor(
    ...
    public approve_proposals: string[] = [],
    public name: string = "",
